...
const NavBar = () => {
    ...
    return (
        <>
            <section className='flex px-[50px] items-center justify-between z-50 mt-[30px] fixed w-full'>
                <img src={Logo}
                ...
                <div className='flex relative justify-center items-center'>
                    <NavigationMenu>
                        <NavigationMenuList className='space-x-6'>
                            ...
                            <NavigationMenuItem>
                                <NavLink className='text-xl' to="/about" legacyBehavior passHref>
                                    <NavigationMenuLink className=''>
                                        About
                                    </NavigationMenuLink>
                                </NavLink>
                            ...
                            <NavigationMenuItem>
                                <NavLink className='text-xl ' to="/contact" legacyBehavior passHref>
                                    <NavigationMenuLink>
                                        Contact
                                    </NavigationMenuLink>
                                </NavLink>
